...
<body>
  ...
  <div align="center">
    <center>
        <div class="hasta-yazi" style="float: left; padding: 1px; margin-top: 83px; font-size: 66px; width: 152px; margin-left: -130px; color: white;"><p style="writing-mode: tb;margin-left: 55px;">RANDEVU EKLE </p></div>
    <div class="hasta-giris">
        <p style="background: #00cb86;border-top-right-radius: 10px; border-top-left-radius: 10px;font-size: 24px; color: #fff;">Randevu Ekle</p>
  ...
  <div class="form-group">
    ...
    <div class="form-group">
    <label class="kayitbilgileri">Onaylamak için doktorun tam adını giriniz.</label>
    <input type="text" class="form-control" id="DoktorAd" name="DoktorAd" placeholder="Örn:Prof.Dr.Erhan Hızlı">
  </div>
      <div class="form-group">
  ...
  <input type="submit" name="submit" value="Radevu Ekle" class="btn btn-primary"  >
</form>
