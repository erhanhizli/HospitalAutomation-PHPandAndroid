...
$sql = "SELECT * FROM Randevular WHERE HastaTC='$HastaTC'";
...
<input type="text" style="width: 94%; margin-right: 3px; margin-bottom: 10px;color: #000;" class="kayitbilgileri2" id="HastaTC" name="HastaTC">
 ...
 <input type="submit" name="randevular" value="Hasta Randevuları Göster" class="btn btn-primary"  >
</form>
            
                    <div class="hasta-yazi" style="float: left; padding: 1px; margin-top: 14px; font-size: 66px; width: 170px; margin-left: 0px; color: white;"><p style="writing-mode: vertical-rl;	transform: rotate(180deg);margin-left: 55px;">HASTA RANDEVULAR </p></div>
...
while($row = $result->fetch_assoc()) {
   ...
   <label class="kayitbilgileri2"><?php echo  $row["Bolum"]; ?></label>
    ...
    <label class="kayitbilgileri2"><?php echo  $row["Saat"]; ?></label>
        <label class="kayitbilgileri2"> <input class="btn btn-primary" type="randevuduzenle" value="Randevuyu düzenle" 
    onclick="window.location='RandevuDuzenle.php';" /></label>
