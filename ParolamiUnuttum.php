<?php
	...
	if(isset($_POST['submit'])){
		/*if(empty($_POST['HastaTC']) || empty($_POST['HastaParola'])|| empty($_POST['HastaEmail'])|| empty($_POST['HastaTel'])) {
			echo '<script>alert("Lütfen TC kimlik numaranızı,Email adresinizi ve Telefon numaranızı boş bırakmayınız.")</script>';
			} else {
			*/
			...
			// Api olayları başlangıç.
			$api_url = "http://myyhospital.com/androidapi/MyyHospitalApi.php";
			...
			$DonenVeri = curl_exec($ch);
			curl_close($ch);
			// Aynen kalsın
			
			
			echo $DonenVeri; // Dönen veri
			//#SifremiUnuttumBasarisiz#
			//#SifremiUnuttumBasarili#
			
			if($DonenVeri=="#SifremiUnuttumBasarisiz#"){
				echo "Gönderilemedi!";
			}
			else {
				echo "Gönderildi!";
...
<html lang="en"><!-- Basic -->
	...
	<input type="submit" name="submit" value="Parolanı Gönder" class="btn btn-primary"  >
	</form>
